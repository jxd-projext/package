    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (currentAudioId >= 0) {
			...
			if (MusicUtils.isVoiceCapable(this)){
                ...
                // Elink_liaobz add USE_AS_ALARM_RINGTONE 2014-4-14
                menu.add(0, USE_AS_ALARM_RINGTONE, 0, R.string.alarm_ringtone_menu_short)
                        .setIcon(R.drawable.ic_menu_set_as_ringtone);
			}
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        try {
            switch (item.getItemId()) {
                ...
                // Elink_liaobz add USE_AS_ALARM_RINGTONE 2014-4-14 <<
                case USE_AS_ALARM_RINGTONE: {
                    Uri ringUri = ContentUris.withAppendedId(
                        MediaStore.Audio.Media.EXTERNAL_CONTENT_URI,
                        mService.getAudioId());
                    Intent mIntent = new Intent("com.elinktek.setAlarmRingtone");
                    mIntent.putExtra("alert", ringUri.toString());
