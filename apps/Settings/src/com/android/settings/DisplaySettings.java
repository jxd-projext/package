...
// Elink_liaobz add 2013-7-16 for tp proximity
import java.io.File;
...
public class DisplaySettings extends SettingsPreferenceFragment implements
    ...
    // Elink_liaobz add 2013-7-16 for tp proximity
    private static final String KEY_TP_PROXIMITY = "tpproximity";
    ...
    // Elink_liaobz add 2013-7-16 for tp proximity
    private CheckBoxPreference mTPProximity;
    ///M: MTK feature
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Elink_liaobz add 2013-7-16 for tp proximity <<
        mTPProximity = (CheckBoxPreference) findPreference(KEY_TP_PROXIMITY);
        mTPProximity.setOnPreferenceChangeListener(this);
        // Elink_liaobz add >>
        ...
        // Elink_liaobz add 2013-10-9
        try {
            File file = new File("/sys/elink/tp_alsps_en");
            if (!file.exists()) {
                mDisplaySettingsExt.removePreference(mTPProximity);
            }
        } catch (Exception e){
            Log.e(TAG, "liaobz:rm tpproximity preference failed!");
            e.printStackTrace();
        }
    }
    @Override
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        ...
        // Elink_liaobz add 2013-7-16 for tp proximity <<
        if (KEY_TP_PROXIMITY.equals(key)) {
            try {
                File file = new File("/sys/elink/tp_alsps_en");
