...
public class StorageVolumePreferenceCategory extends PreferenceCategory {
    ...
    public void updateDetails(MeasurementDetails details) {
        ...
        // ELink_liaobz 2014-2-26 update storage info <<
        // StatFs system_fs = new StatFs("/system");
        // StatFs data_fs = new StatFs("/data");
        // StatFs cache_fs = new StatFs("/cache");
        // long android_fs = system_fs.getBlockSize() * system_fs.getBlockCount() +
        //     data_fs.getBlockSize() * data_fs.getBlockCount() +
        //     cache_fs.getBlockSize() * cache_fs.getBlockCount();
