...
public final class AlarmStateManager extends BroadcastReceiver {
    ...
    private static void scheduleInstanceStateChange(Context context, Calendar time,
        ...
        but if it's tablet multi-user or device has been encrypted set as normal alarm */
        if (newState == AlarmInstance.FIRED_STATE && !isNotTabletOwner()
                && PowerOffAlarm.deviceUnencrypted()) {
